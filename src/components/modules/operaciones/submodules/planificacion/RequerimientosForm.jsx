...
export const RequerimientosForm = ({ semanaId, onClose }) => {
  ...
  const montoTotal = (formData.cantidad_requerida || 0) * (formData.precio_unitario_aprox || 0);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onClose(); // Cerrar y volver a la lista de días
    } catch (error) {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-grid cols-3" style={{ marginTop: '20px' }}>
          ...
          <div className="form-group">
            ...
            <div className="form-control-static">${montoTotal.toLocaleString()}</div>
          </div>
        </div>
